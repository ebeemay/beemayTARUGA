...
@section('content')
    ...
    <div class="container mb-5">
        <section class="module" style="background: #8FCAEB;">
            <!--Fundo modulo-->
            <h2 class="module-title">Módulo 1 - LIBRAS: Gramática</h2>

            
            <div class="row d-flex align-items-center justify-content-center">
                <div class="col-md-3 mb-3 d-flex align-items-center justify-content-center">
                <form action="{{ route('iniciar.progresso', ['materia' => 'libras', 'numeroAtividade' => 1]) }}" method="POST">
            @csrf
            <button type="submit" class="btn btn-link p-0">
                    <div class="card">
                        <div class="card-body bg-warning d-flex align-items-center justify-content-center">
                            <img src="https://itens-cabecalho.s3.us-east-1.amazonaws.com/LetrasModule.png" alt="Módulo 1, Aprendendo o alfabeto em libras"
                                class="img-fluid">
        ...
        <section class="module" style="margin-top: 50px; background: #F0A157;">
            <h2 class="module-title"> Módulo 2 - LIBRAS: Consciência visual </h2>
            <div class="row d-flex align-items-center justify-content-center">
                <div class="col-md-3 mb-3 d-flex align-items-center justify-content-center">
